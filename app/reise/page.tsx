  ...
  return (
    <main className="subpage">
      ...
      <section className="travel section-pad">
        <div className="section-heading"><p className="kicker">Reise</p><h1 className="page-title">Hvordan komme seg dit?</h1><p>Det enkleste er å fly til Roma eller Firenze og leie bil videre til SPAO. Dere ordner transport til stedet selv, og vi anbefaler gjerne samkjøring. Beregn litt ekstra tid ved mye trafikk.</p><p>SPAO kan formidle kontakt med lokale taxiselskaper, minibusser og busselskaper. Transport bør avtales og bestilles på forhånd. Ta gjerne kontakt med oss dersom dere ønsker kontaktinformasjon.</p></div>
