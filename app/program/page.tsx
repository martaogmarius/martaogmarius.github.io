    ...
    <main className="subpage">
      ...
      <section className="weekend section-pad">
        ...
        <div className="schedule">
          ...
          <article className="day-card cream"><p className="day-number">27</p><p className="day-name">Søndag · juni</p><h3>Frokost & avreise</h3><p>Frokost og en rolig morgen før utsjekk.</p><span>Utsjekk senest kl. 11.30</span></article>
        </div>
      </section>
      <SiteFooter />
    </main>
